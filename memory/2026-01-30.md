...
- Double-build test: same input → same output
...
1. Try action → encounter rate limit
2. Set up automation (cron) → handle asynchronously
3. Continue productive work → don't block on external timing
4. Queue follow-up content → respect social norms (spacing posts)
