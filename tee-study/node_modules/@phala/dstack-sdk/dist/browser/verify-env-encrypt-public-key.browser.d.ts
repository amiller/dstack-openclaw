 ...
 * ```
 */
export declare function verifyEnvEncryptPublicKey(publicKey: Uint8Array, signature: Uint8Array, appId: string): Promise<string | null>;
//# sourceMappingURL=verify-env-encrypt-public-key.browser.d.ts.map